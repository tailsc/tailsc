...
@onready var forward : Button = $"ColorRect/Panel/ScrollContainer/PanelContainer/MarginContainer/TabContainer/Key Bindings/forwardPanel/forward"
@onready var backward : Button = $"ColorRect/Panel/ScrollContainer/PanelContainer/MarginContainer/TabContainer/Key Bindings/backwardPanel/backward"
@onready var left : Button = $"ColorRect/Panel/ScrollContainer/PanelContainer/MarginContainer/TabContainer/Key Bindings/leftPanel/left"
@onready var right : Button = $"ColorRect/Panel/ScrollContainer/PanelContainer/MarginContainer/TabContainer/Key Bindings/rightPanel/right"
@onready var action : Button = $"ColorRect/Panel/ScrollContainer/PanelContainer/MarginContainer/TabContainer/Key Bindings/clickPanel/click"
