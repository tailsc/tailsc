...
<ul style="list-style-type: none; margin: 0; padding: 0;">
  <li style="display: inline-block; margin: 0; padding: 0;"> <!-- Reset margin and padding for the list item -->
    <a href="https://www.ko-fi.com/supercrow" style="display: block;"> <!-- Set display: block; for the anchor tag to remove any remaining space -->
      <img src="https://storage.ko-fi.com/cdn/kofi2.png?v=3" width="150" style="display: block; border: none;"/> <!-- Add display: block; and border: none; to the image -->
    </a>
  </li>
</ul>
